...
Your browser does not support the video tag.
      ...
      <div class="modal-footer" style="padding-right: 0px;padding-left: 0px;">
        ...
        <a href="<?php echo $lvideo; ?>" download title="Download SD" class="btn btn-primary" style="color:white;background: #38A2C3">Download 360P</a>
        	<?php if($mvideo != ""){ ?>
        <a href="<?php echo $mvideo; ?>" download title="Download 540P" class="btn btn-info" style="color:white;background: #817FFF">Download 540P</a>
        	<?php } ?>
        	<?php if($hvideo != ""){ ?>
        <a href="<?php echo $hvideo; ?>" download title="Download HD" class="btn btn-success" style="color:white;background:#7ED214">Download 720HD</a>
        	<?php } ?>
      </div>
    </div>
  </div>
